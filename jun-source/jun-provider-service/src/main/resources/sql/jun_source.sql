...
Source Database       : jun_source

Target Server Type    : MYSQL
Target Server Version : 50627
File Encoding         : 65001

Date: 2017-02-17 16:34:34
*/
...
CREATE TABLE `sys_menu` (
  ...
  `type` tinyint(2) DEFAULT NULL COMMENT '类型  1：目录   2：菜单   3：按钮',
  `icon` varchar(50) DEFAULT NULL COMMENT '菜单图标',
  `order_num` int(5) DEFAULT NULL COMMENT '排序（数字越小越靠前）',
...
CREATE TABLE `sys_user` (
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '用户状态 1 启用 2 禁用',
  `create_name` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_name` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
