	...
	<form class="form-horizontal">
		<div class="form-group">
			...
			<label class="radio-inline">
			  <input type="radio" name="type" value="1" v-model="menu.type"/> 目录
			</label>
			<label class="radio-inline">
			  <input type="radio" name="type" value="2" v-model="menu.type"/> 菜单
			</label>
			<label class="radio-inline">
			  <input type="radio" name="type" value="3" v-model="menu.type"/> 按钮
			</label>
		</div>
		<div class="form-group">
		...
		<div v-if="menu.type == 2 || menu.type == 3" class="form-group">
		...
		<div v-if="menu.type != 3" class="form-group">
...
<script src="${CONTEXT}/js/sys/menu_add.js?_${date.systemTime}"></script>
</body>
</html>